...
export const BetterNumInput = forwardRef(
  ({ min, max, step, allowWheel, onWheel, ...props }: Props, ref: Ref<HTMLInputElement>) => {
        ...
        onBlur={(e) => {
          ...
          if (min) {
            ...
            if (quotient * step + min !== value) {
              ...
              const correct =
                Math.abs(value - smaller) < Math.abs(value - larger) ? smaller : larger
...
BetterNumInput.displayName = 'BetterNumInput'
