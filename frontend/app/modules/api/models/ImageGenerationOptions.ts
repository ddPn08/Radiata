...
/**
 * Check if a given object implements the ImageGenerationOptions interface.
 */
export function instanceOfImageGenerationOptions(value: object): boolean {
    let isInstance = true;
...
export function ImageGenerationOptionsFromJSON(json: any): ImageGenerationOptions {
    return ImageGenerationOptionsFromJSONTyped(json, false);
}

export function ImageGenerationOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImageGenerationOptions {
...
export function ImageGenerationOptionsToJSON(value?: ImageGenerationOptions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
